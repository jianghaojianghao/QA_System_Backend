...
class QuestionPaser:
    ...
    def parser_main(self, res_classify):
        # {'args': {'感冒': ['disease']}, 'question_types': ['disease_desc']}
        ...
        for question_type in question_types:
            ...
            # sql ["MATCH (m:Disease) where m.name = '感冒' return m.name, m.desc"]
            if sql:
                sql_['sql'] = sql
                sqls.append(sql_)

        # [{'question_type': 'disease_desc', 'sql': ["MATCH (m:Disease) where m.name = '感冒' return m.name, m.desc"]}]
        return sqls
...
if __name__ == '__main__':
    ...
    data = handler.parser_main({'args': {'感冒': ['disease']}, 'question_types': ['disease_desc']})
    print(data)
